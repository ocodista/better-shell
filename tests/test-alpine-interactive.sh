...
# Container name
CONTAINER_NAME="better-terminal-alpine-dev"
...
docker build -f tests/alpine/Dockerfile -t better-terminal-alpine . -q

echo "🚀 Starting container in background..."
docker run -d --name $CONTAINER_NAME better-terminal-alpine tail -f /dev/null
